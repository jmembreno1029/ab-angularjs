...
addressbook.controller("BcardsController", function BcardsController(
  $scope
){
  $scope.bcards = [
    {
...
addressbook.controller("ContactsController", function ContactsController(
  $scope
) {
  $scope.contacts = [
    {
